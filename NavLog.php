    ...
    echo "
        <div class=\"container-fluid\" id=\"header\">
            <div class=\"navbar row text-center \">
                <div class=\"col-2\">
                    <img src=\"http://localhost/web/resources/logo.png\" style=\"height: 40px; cursor: pointer\" alt=\"Apple Logo\">
                </div>
                ...
                <div class=\"col-2 d-flex justify-content-end align-self-center\">
                    <span class=\"material-icons-outlined icon\" style='cursor: pointer' onclick=\"window.location.href='http://localhost/web/news/'\">newspaper</span>
