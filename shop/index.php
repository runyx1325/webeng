        ...
        <div class="col d-flex flex-row justify-content-center">
            <div class="card">
                <div class="d-flex flex-column justify-content-center align-items-center">
                    ...
                    <div class="box d-flex align-items-center justify-content-center" onclick=addCart(1) style="border-style: solid; width: 150px; margin-top: 2rem; cursor: pointer; margin-bottom: 2rem">
        ...
        <div class="col d-flex flex-row justify-content-center">
            <div class="card">
                <div class="d-flex flex-column justify-content-center align-items-center">
                    ...
                    <div class="box d-flex align-items-center justify-content-center" onclick=addCart(2) style="border-style: solid; width: 150px; margin-top: 2rem; cursor: pointer; margin-bottom: 2rem">
                        <span class="material-icons-outlined icon" style="margin-right: 0!important;">add_shopping_cart</span>
                    </div>
                </div>
            </div>
        ...
        <div class="col d-flex flex-row justify-content-center">
            <div class="card">
                <div class="d-flex flex-column justify-content-center align-items-center">
                    ...
                    <div class="box d-flex align-items-center justify-content-center" onclick=addCart(3) style="border-style: solid; width: 150px; margin-top: 2rem; margin-bottom: 2rem; cursor: pointer">
                        <span class="material-icons-outlined icon" style="margin-right: 0!important;">add_shopping_cart</span>
                    </div>
                </div>
            </div>
